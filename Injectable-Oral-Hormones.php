...
<h3 class="mb-5"> Injectable / Oral <span class="theme-color"> Hormones</span> </h3>
<div class="blog-details">
<div class="row">
<!-- <div class="col-sm-7">

<h4>Global Labs Platinum Series Available</h4>
<p>
<p>We are pleased to inform you that we have launched new Global Labs Platinum Series&nbsp;(injectable) along with existing (Ultimate Series)</p>
...</p>
...
<!-- <div class="col-sm-5">
<figure>
<img src="admin/products/15959230820172205916.jpg" class="img-fluid" alt="gonadorelin">
</figure>
</div> -->
...
<?php
              $ff='SELECT * from product Where product_subcategory =2 order by id DESC  ';
