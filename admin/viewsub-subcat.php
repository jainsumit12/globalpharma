...
if(isset($_GET['deletecat'])){
    ...
    $field = array('sub_subcategory_id');
                ...
                <div class="vd_container">
                    <div class="vd_content clearfix">
                        ...
                        <div class="vd_content-section clearfix">
                                        ...
                                        <div class="panel-body-list  table-responsive">
                                            <table class="table table-striped table-hover no-head-border">
                                                ...
                                                foreach($res as $ke=>$value){
                                                    $table = "category";
                                                    $field_value = array($value['category_id']);
						 ...
						 <td class="menu-action rounded-btn"><a href="editsubsubcat.php?subcatid='.$value['sub_subcategory_id'].'" data-original-title="edit" data-toggle="tooltip" data-placement="top" class="btn menu-icon vd_bg-grey"> <i class="fa fa-pencil"></i> </a> <a href="viewsub-subcat.php?deletecat='.$value['sub_subcategory_id'].'""   data-original-title="delete" data-toggle="tooltip" data-placement="top" class="btn menu-icon vd_bg-grey"> <i class="fa fa-times"></i> </a></td>
                        </tr>';}}}?>
