...
<div class="vd_body">
	...
	$query = "SELECT * from servicesgallery where id='".@$_GET['catid']."'";
	...
	$run = mysqli_query($conn, $query);
                 ...
                 <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                          ...
                          <input class="width-70" type="text" placeholder="Input" value="<?php echo $dataval['video'];  ?>" data-toggle="tooltip" data-placement="top" name="content" >
                        </div>
                      </div>
                  ...
                  <br>
                   <img src="../images/slider/<?php echo $dataval['image'];  ?>"width="50px">
                  </div>
                </div>
...
$title = $_POST['content'];  
	...
	$query1 = "UPDATE servicesgallery SET video='$title'  where id='".$_POST['edit_id']."'";

	$me=mysqli_query($conn,$query1);
	 
$image_name5 = $_FILES['image']['name'];
     if($image_name5!=""){
	 
	 $image_type5 = $_FILES['image']['type'];
	 $image_size5 = $_FILES['image']['size'];
	 $image_tmp5 = $_FILES['image']['tmp_name'];    
       $random_digit5=rand(0000,9999);
	   $imagename5 = $random_digit5.$image_name5;
	   move_uploaded_file($image_tmp5, "../images/slider/$imagename5");
	   $query1 = "UPDATE servicesgallery SET image='$imagename5'  where id='".$_POST['edit_id']."'";
       $me=mysqli_query($conn,$query1);
	  }

 echo'<script>location.assign("viewservice1.php")</script>';
