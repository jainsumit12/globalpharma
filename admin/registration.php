...
?>               	
                        <tr class="odd gradeX">
                         <td><?php echo $i++; ?></td>
                          <td>name : <?php echo $row['name']; ?><br>last : <?php echo $row['last']; ?><br>
                          	Email : <?php echo $row['email']; ?><br>
                          	Phone : <?php echo $row['mobile']; ?><br>	Date : <?php echo $row['date']; ?><br>
                          </td>
                          
                           <td>country : <?php echo $row['country']; ?><br>
                          	state : <?php echo $row['state']; ?><br>
                          	city : <?php echo $row['city']; ?><br>
                          </td>
                           <td>house : <?php echo $row['house']; ?><br>
                          	street : <?php echo $row['street']; ?><br>
                          	apartment : <?php echo $row['apartment']; ?><br>
                          	zip : <?php echo $row['zip']; ?><br>
                          </td>
                      <td>website : <?php echo $row['house']; ?><br>
                          	company : <?php echo $row['street']; ?><br>
                          	model : <?php echo $row['apartment']; ?><br>
                          	camera : <?php echo $row['zip']; ?><br>	Drone Sensors : <?php echo $row['other']; ?><br>
                          </td>
