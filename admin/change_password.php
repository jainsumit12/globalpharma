...
$title = $_POST['admin_account_password']; 
$emaile = $_POST['admin_account_email']; 
$query="update admin_account set admin_account_password='$title',admin_account_email='$emaile'  where id='2'";
...
<div class="vd_body">
                    ...
                    <div class="vd_content clearfix">
                        ...
                        <div class="vd_title-section clearfix">
                            <div class="vd_panel-header">
                                ...
                                <small class="subtitle">Edit  Change Password</small>
                            ...
                            <div class="col-md-12">
                                <div class="panel widget">
                                    ...
                                    <div class="panel-body">
                                        <?php
                                        $ss="SELECT * from admin_account where id='2'";
                                        ...
                                        <form class="form-horizontal" action="" method="post" role="form" enctype="multipart/form-data">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-7 controls">
                                                    <input class="width-70" type="text" value="<?php echo $dataval['admin_account_email']; ?>" data-toggle="tooltip" data-placement="top" name="admin_account_email">
                                                </div>
                                            </div>
 ...
 <div class="form-group">
                                                ...
                                                <div class="col-sm-7 controls">
                                                    <input class="width-70" type="text" value="<?php echo $dataval['admin_account_password']; ?>" data-toggle="tooltip" data-placement="top" name="admin_account_password">
                                                </div>
                                            </div>
