...
if(isset($_GET['del'])){
	...
	$query = "delete from servicesgallery where id ='".$delete_id."'";
                                        ...
                                        <div class="panel-body-list  table-responsive">
                                            <table class="table table-striped table-hover no-head-border">
                                                ...
                                                foreach($res as $ke=>$value){
                                                    echo'<tr>
                          <td><img style="height:100px;" src="../images/slider/'.$value['image'].'"></td>
                           <td>'.$value['video'].'</td>
                         <td>'.$value['type1'].'</td>
						 <td class="menu-action rounded-btn"><a href="editservice1.php?catid='.$value['id'].'" data-original-title="edit" data-toggle="tooltip" data-placement="top" class="btn menu-icon vd_bg-grey"> <i class="fa fa-pencil"></i> </a> <a href="viewservice1.php?del='.$value['id'].'""   data-original-title="delete" data-toggle="tooltip" data-placement="top" class="btn menu-icon vd_bg-grey"> <i class="fa fa-times"></i> </a></td>
                        </tr>';}?>
