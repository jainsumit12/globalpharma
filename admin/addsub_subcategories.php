...
$field_value=array($subcategory_name,$category_name,$sub_subname);
$field =array('subcategory_id','category_id','sub_subcategory_name');
              ...
              <div class="col-md-12">
                <div class="panel widget">
                  <div class="panel-heading vd_bg-grey">
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-bar-chart-o"></i> </span> Add Sub Subcategory </h3>
                  </div>
                ...
                <div class="form-group">
                        <label class="col-sm-2 control-label">Add Sub_Subcategory Name</label>
                        <div class="col-sm-7 controls">
