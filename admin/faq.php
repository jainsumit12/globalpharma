...
$field_value=array($question,$answer);
$field=array('question','answer');
                  ...
                  <div class="panel-body">
                    <form class="form-horizontal" action="#" method="post" role="form" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        <label class="col-sm-2 control-label">Add Course title</label>
                       ...
                       <div class="form-group">
                        <label class="col-sm-2 control-label">Add Course Discription</label>
                        <div class="col-sm-7 controls">
                          
                          <textarea class="ckeditor"  id="" cols="70" name="answer"  required rows="20">
