...
$table = "sub_subcategory";
    ...
    $field=array('sub_subcategory_id','sub_subcategory_name','subcategory_id','category_id');
...
if(isset($_POST['btn-save']))
{
    ...
    $catname = $_POST['sub_subcategory_name'];
		 ...
		 $field_value=array($subcatid,$catname,);
        $field =array('sub_subcategory_id','sub_subcategory_name',);
