 ...
 if(isset($_POST['submit']))
{
	...
	$query="UPDATE contact_info SET address='".$address."', phone='".$phone."',us='".$us."', email='".$email."'";
...
?>
					...
					<div class="form-group">
                        <label class="col-sm-2 control-label">Update phone No 1</label>
                        <div class="col-sm-7 controls">
                          <input class="width-70" type="text" value="<?php echo $phone; ?>" data-toggle="tooltip" data-placement="top" name="phone" >
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="col-sm-2 control-label">Update phone No </label>
                        <div class="col-sm-7 controls">
                     ...
                     <div class="form-group">
                         <label class="col-sm-2 control-label">Update Email id (first)</label>
                        <div class="col-sm-7 controls">
                      ...
                      <div class="form-group">
                        <label class="col-sm-2 control-label">Update address</label>
                        <div class="col-sm-7 controls">
