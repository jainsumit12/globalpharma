...
$title = $_POST['title'];
$content = $_POST['content'];$type = $_POST['type'];
 
$imagename = $_POST['image'];
$sel="INSERT into services (service,content,image ) VALUES('$title','$content','$imagename' )";
...
<!-- vd_panel-menu --> 
                ...
                <div class="panel widget">
                  ...
                  <div class="panel-body">
                   ...
                   <div class="form-group">
                        <label class="col-sm-2 control-label">Title of Service</label>
 ...
 <div class="form-group">
                  <label class="col-sm-2 control-label">Content of Service:</label>
                  <div class="col-sm-8">
                    ...
                    <textarea  class="ckeditor"   name="content" ><?php echo $dataval['content']; ?></textarea>
					   ...
					   <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                          ...
                          <input class="width-70" type="text" placeholder="Input" data-toggle="tooltip" data-placement="top" required name="image" >
                        </div>
                      </div>
