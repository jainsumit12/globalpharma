...
if(isset($_GET['addtaxid'])){
    if(isset($_POST['btn-save']))
    {
        ...
        $today = date('Y-m-d');
        $field_value=array($vat,$cst,$country,$state,$today);
        $field=array('vat','cst','country','state','date');
...
if(isset($_GET['edittaxid'])){
    ...
    if(isset($_POST['btn-save']))
    {
        ...
        $vat = $_POST['vat'];
        $cst = $_POST['cst'];
        $field_value=array($Taxid,$vat,$cst);
        $field=array('tax_id','vat','cst');
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="panel-body">';
                                       ...
                                       echo'<form class="form-horizontal" action="" method="post" role="form">
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-2 control-label">CST (%) </label>
                                                <div class="col-sm-7 controls">
                                                    <input class="width-70" type="number" value="'.$editdataval['cst'].'" data-toggle="tooltip" data-placement="top" name="cst">
                                                </div>
                                            </div>
                                    ...
                                    <div class="panel-body">
                                        <form class="form-horizontal" action="" method="post" role="form">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-7 controls">
                                                      <select name="country_id" class="width-70 country_id" title="Country" id="countryId" required>
                                                        <option value="" >Select Country </option>';

                                                        foreach($countries as $key => $countryval){
                                                            echo' <option value="'.$countryval['id'].'">'.$countryval['name'].'</option>';
                                                        }
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-7 controls">
                                                    <select id="region_id" name="region_id" title="State/Province" class="width-70" required> </select>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-sm-2 control-label">VAT </label>
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-2 control-label">CST</label>
                                                <div class="col-sm-7 controls">
                                                    <input type="number" class="width-70" id="datetimepicker_dark" name="cst" data-rules-required="true" >
                                                </div>
                                            </div>
        ...
        <div class="vd_bottom ">
            <div class="container">
                <div class="row">
                    <div class=" col-xs-12">
                        <div class="copyright">
                            Copyright &copy;2016 BonitoPanos Inc. All Rights Reserved
                        </div>
                    </div>
                </div><!-- row -->
            </div><!-- container -->
