...
<div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <textarea   name="content" class="ckeditor" ><?php echo $dataval['about_us']; ?></textarea>
                  </div>
                </div>
  ...
  <div class="form-group">
                 ...
                 <div class="form-group">
                  <label class="col-sm-2 control-label">Socail Youtube :</label>
                  <div class="col-sm-8">
...
//	   move_uploaded_file($image_tmp, "../images/$imagename");
	  ...
	  $query1 = "UPDATE contact_info SET about_us='$content' , term='$term',privacy_policy='$privacy' ,link1='$link1',link2='$link2',link3='$link3',link4='$link4' where id='1'";
