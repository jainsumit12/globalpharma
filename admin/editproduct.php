...
$table="product";
$sku = $_GET['sku'];
$field = array('id','product_name','description','short_description');
...
$field_value=array($sku,$product_name,$product_des,$short_description);
$field = array('id','product_name','description','short_description');
              ...
              <div class="col-md-12">
                ...
                <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                          <textarea  id="short_description" name="short_description"  ><?php echo $value['description'] ?> </textarea>
                        </div>
                      </div> 
                      <div class="form-group">
                        <label class="col-sm-2 control-label">Edit Product Description/about</label>
                        <div class="col-sm-7 controls">
                          <textarea id="content" name="content"><?php echo $value['short_description'] ?> </textarea>
                        </div>
                      </div> 
