...
<div class="content">
              ...
              <div class="col-md-12">
                <div class="panel widget">
                  <div class="panel-heading vd_bg-grey">
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-dot-circle-o"></i> </span> view  Document Panel</h3>
                  </div>
 ...
 $query="SELECT * from certificate order by id DESC";
	...
	$run = mysqli_query($conn,$query);
					   foreach($run as $ke=>$value){
					   	$query1="SELECT * from registration where id='".$value['user_id']."' order by id DESC";

	$run1 = mysqli_query($conn,$query1);
	 foreach($run1 as $ke=>$value1)
					   	 ?>
                        <tr>
                          
                          <td><?php echo $value1['name'] ;?></td>
                          <td class=" "><b></b> <?php echo $value['user_id'];?></td>
                         <td><?php echo $value1['mobile'] ;?>  <?php echo $value1['email'] ;?></td> 
 ...
 <td> <a href="../images/document/<?php echo $value['image'] ;?>" target="_blank"> <img height="80px" src="../images/document/<?php echo $value['image'] ;?>"> </a></td>
