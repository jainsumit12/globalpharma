...
$image_name = $_FILES['image']['name'];
	 ...
	 $random_digit=rand(0000,9999);
	  ...
	  move_uploaded_file($image_tmp,"../images/document/$imagename");

$sel="INSERT into document (content,image) VALUES('$title','$imagename')";
...
window.location ='viewdocument.php'
</script>
<?php
}
else{
              ...
              <div class="col-md-12">
                <div class="panel widget">
                  <div class="panel-heading vd_bg-grey">
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-bar-chart-o"></i> </span> Document services </h3>
                  </div>
                  <div class="panel-body">
                   ...
                   <div class="form-group">
                        <label class="col-sm-2 control-label">Title of document</label>
                   ...
                   <div class="form-group">
                        <label class="col-sm-2 control-label">Add document Image</label>
                        <div class="col-sm-7 controls">
