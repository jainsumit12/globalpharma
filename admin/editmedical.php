	...
	$run = mysqli_query($conn, $query);
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                          ...
                          <input class="width-70" type="text" placeholder="Input" value="<?php echo $dataval['medical'];  ?>" data-toggle="tooltip" data-placement="top" name="title" >
                        </div>
                      </div>
      ...
      <textarea class="ckeditor" id="" cols="70" name="content" rows="20" ">                                    		
                                    <?php echo $dataval['content'];  ?>	</textarea>                      </div>
                      </div>
...
$content = $_POST['content'];
	...
	$query1 = "UPDATE medical SET medical='$title', content='$content' where id='".$_POST['edit_id']."'";
 ...
 echo'<script>location.assign("viewmedical.php")</script>';
