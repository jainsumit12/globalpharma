...
<div class="vd_body">
	...
	$query = "SELECT * from admin_account where id='1'";
...
$content = $_POST['password'];
	...
	$query1 = "UPDATE admin_account SET admin_account_email='$title', admin_account_password='$content' where id='1'";

	$me=mysqli_query($conn,$query1);
	 


 echo'<script>location.assign("index.php.php")</script>';
