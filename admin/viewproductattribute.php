                    ...
                    <div class="vd_content clearfix">
                        <div class="vd_head-section clearfix">
                            <div class="vd_panel-header">
                                <ul class="breadcrumb">
                                    <li><a href="">Home</a> </li>
                                    <li class="active">Tea Trading Dashboard</li>
                                </ul>
                                            ...
                                            <table class="table table-striped table-hover no-head-border">
                                                ...
                                                foreach($result as $key =>$valattr){
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo $valattr['price'] ;?></td>
                                                        
                                                        <td class="menu-action"><a href="editattribute.php?edit=<?php echo $valattr['id']; ?>" data-original-title="edit" data-toggle="tooltip" data-placement="top" class="btn menu-icon vd_bd-yellow vd_yellow" > <i class="fa fa-pencil"></i> </a> <a href="viewproductattribute.php?color=<?php echo $valattr['id']; ?>" data-original-title="delete" data-toggle="tooltip" data-placement="top" class="btn menu-icon vd_bd-red vd_red  confirmation"> <i class="fa fa-times"></i> </a></td>
                                                    </tr>
                                                <?php $i++ ; }?>
