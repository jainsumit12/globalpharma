...
<!-- vd_panel-menu --> 
                   ...
                   <form class="form-horizontal" action="" method="post" name="form" role="form" enctype="multipart/form-data">
					...
					<div class="form-group">
                      ...
                      <div class="form-group">
                       ...
                       <button class="btn vd_btn vd_bg-green vd_white" type="submit" name="btn-save1"><i class="icon-ok"></i> Save</button>
                    </form>
                     <?php 
						  if(isset($_POST['btn-save1']))
						  {
						    	$in="INSERT into news (`name` ,`link`,`type`) VALUES ('".$_POST['name']."' ,'".$_POST['link']."','".$_POST['type']."')";
        ...
        "</script>";
echo'<script>location.assign("add_news.php")</script>';
