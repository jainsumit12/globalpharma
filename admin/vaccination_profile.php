              ...
              <div class="col-sm-3">
                <div class="panel widget light-widget panel-bd-top">
                  ...
                  <div class="panel-body">
                    <div class="text-center vd_info-parent"> <i class="icon-user mgr-10 profile-icon"></i> </div>

                    <h2 class="font-semibold mgbt-xs-5" style="text-align:center;">'.ucfirst($cus_details['name']).'</h2>
        ...
        <div class="row">
          ...
          <div class="col-sm-6">
            <div class="row mgbt-xs-0">
              <label class="col-xs-5 control-label">Owner Name :</label>
              <div class="col-xs-7 controls">'.$cus_details['name'].'</div>
              <!-- col-sm-10 -->
            </div>
          </div>
          <div class="col-sm-6">
            <div class="row mgbt-xs-0">
              ...
              <div class="col-xs-7 controls">'.$cus_details['mobile'].'</div>
              <!-- col-sm-10 -->
            </div>
          </div>
          <div class="col-sm-6">
          ...
          <div class="col-sm-6">
            <div class="row mgbt-xs-0">
              ...
              <div class="col-xs-7 controls">'.$cus_details['password'].'</div>
              <!-- col-sm-10 -->
            </div>
          </div>
