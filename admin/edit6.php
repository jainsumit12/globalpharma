 ...
 if(isset($_POST['submit']))
{
	 ...
	 $name = $_POST['name'];
	 $content = $_POST['content']; $info= $_POST['info'];
	...
	//$query="INSERT into testimonial (name,content) VALUES ('$name','$content')";
	 ...
	 $image_tmp5 = $_FILES['image5']['tmp_name'];    
	   ...
	   move_uploaded_file($image_tmp5, "../images/service/$imagename5");
	   $query1 = "UPDATE testimonial SET image='$imagename5'  where id='".$_POST['edit_id']."'";
       $me=mysqli_query($conn,$query1);
	  }
	
	 
	 $query="UPDATE testimonial set name='$name',content='$content'  where id='".$_POST['edit_id']."'";
...
while ($row = mysqli_fetch_assoc($run)){
	...
	$id = $row['id'];
	 $content = $row['content'];
	 $name = $row['name'];	 $info = $row['info'];$image = $row['image'];
...
?>
					...
					<div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
  				       ...
  				       <input class="width-70" type="text" value="<?php echo $content; ?>" data-toggle="tooltip"  data-placement="top" name="content" >
                  ...
                  <br>
                   <img src="../images/service/<?php echo $image; ?>"width="50px">
                  </div>
                </div>
