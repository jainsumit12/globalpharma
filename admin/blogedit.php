...
$query="update blog set title='$title', code1='$code1'  where id='$catid'";
                ...
                <div class="vd_container">
                    <div class="vd_content clearfix">
                        ...
                        <div class="vd_title-section clearfix">
                            <div class="vd_panel-header">
                                <h1>Edit Code Dashboard</h1>
                                <small class="subtitle">Edit Code Dashboard</small>
                            ...
                            <div class="col-md-12">
                                <div class="panel widget">
                                    <div class="panel-heading vd_bg-grey">
                                        <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-bar-chart-o"></i> </span> Edit Code </h3>
                                    </div>
                                    <div class="panel-body">
                                        ...
                                        <form class="form-horizontal" action="" method="post" role="form" enctype="multipart/form-data">
                                         ...
                                         <div class="form-group">
                                                <label class="col-sm-2 control-label">Enter code</label>
                                                <div class="col-sm-7 controls">
                                                    <input class="width-70" type="text" value="<?php echo $dataval['code1']; ?>" data-toggle="tooltip" data-placement="top" name="code1">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-2 control-label">Scratch code</label>
                                                <div class="col-sm-7 controls">
