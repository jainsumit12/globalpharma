...
$author  = $_POST['author'];$category = $_POST['category'];$type  = 'download';
if($author!="")
{
	$author=$author;
}
...
$field_value=array($title,$content,$author,$imagename,$status,$date,$type,$category);
$field =array('title','content','author','image','status','date','type','category');
$res = $con->insert($field_value,$table,$field);
if($res)
{
?>
<script>
alert("Download Inserted");
	   ...
	   if(categoryId){
	    $.ajax({
            ...
            success: function (response) {
                ...
                $("#myselect1").php(response);
            },
        });
	   }else{
		    $("#myselect1").php('<option value="">Select Category First</option>');
		    $("#sub_subcategory").php('<option value="">Select Sub Category First</option>');
              ...
              <div class="col-md-12">
                <div class="panel widget">
                  <div class="panel-heading vd_bg-grey">
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-bar-chart-o"></i> </span> Add Blog </h3>
                  </div>
                ...
                <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
		                  ...
		                  <?php
										$select="SELECT * from services order by service ASC";
										$run=mysqli_query($conn,$select); 
										foreach($run as $key=> $service)
										{
                  ...
                  <div class="form-group">
                        <label class="col-sm-2 control-label">Add Blog title</label>
                        <div class="col-sm-7 controls">
                          <input class="width-70" type="text" placeholder="Blog title"  name="title" required>
                        </div>
                      </div>

                      <div class="form-group">
                        <label class="col-sm-2 control-label">Add Blog Image</label>
                        <div class="col-sm-7 controls">
                          <input class="width-70" type="file" placeholder="Product Brand Name"  name="image" required>
                        </div>
                      </div>


                        <div class="form-group">
                        <label class="col-sm-2 control-label">Add Blog Content</label>
                        <div class="col-sm-7 controls">
                          <textarea name="content" class="ckeditor" placeholder="Product Specifications"  required></textarea>
                        </div>
                      </div>
                   ...
                   <!--   <div class="form-group">
                       ...
                       <div class="form-group">
                        <label class="col-sm-2 control-label">Add Blog Author</label>
                        <div class="col-sm-7 controls">
                          <input class="width-70" type="text" placeholder="Blog Author"  name="author" >
                        </div>
                      </div>
