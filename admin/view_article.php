              ...
              <div class="col-md-12">
                <div class="panel widget">
                  <div class="panel-heading vd_bg-grey">
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-dot-circle-o"></i> </span> VIEW BLOG</h3>
                  </div>
                  <div class="panel-body table-responsive">
                    <table class="table table-striped" id="data-tables">
                      ...
                      <tbody>
                        <?php
                           $i=1;
 $query="SELECT * from blog where type='article' order by id DESC ";
...
?>
                       ...
                       <td><img style="width :50px;" src="../images/blog/<?php echo $row['image']; ?>"</td>
                   ...
                   <button class=" " onclick="return confirm('Are you sure?')"><?php if(($row['status'])=='0')
{
?>
<a href="action_article.php?status=<?php echo $row['id'];?>" 
 class="act btn  btn-danger btn-xs" onclick="return confirm('Activate <?php echo $data?>');"> Deactivate </a>
<?php
}
if($row['status']=='1')
{
?>
<a href="action_article.php?status=<?php echo $row['id'];?>" 
 class="deact btn btn-success btn-xs  " onclick="return confirm('De-activate <?php echo $data?>');"> Activate</a>
<?php
} ?> </button>
                    <a href="view_blog.php?delid=<?php echo $row['id']; ?>" data-original-title="delete" data-toggle="tooltip" data-placement="top" class="btn menu-icon vd_bg-grey"> <i class="fa fa-times"></i> </a>
                   <a href="blogedit.php?catid=<?php echo $row['id']; ?>" data-original-title="Edit" data-toggle="tooltip" data-placement="top" class="btn menu-icon vd_bg-grey"> <i class="fa fa-edit"></i> </a></td>
                        </tr>
                       <?php } ?>
                       <?php
                       if(isset($_GET['delid'])){
					   	...
					   	echo'<script>location.assign("view_article.php")</script>';
