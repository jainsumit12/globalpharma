...
$sel="INSERT into servicesgallery (image,video,type,type1) VALUES('$imagename','$title','$type','$type1')";
...
<script>
alert("service Added");
window.location ='viewservice1.php'
</script>
<?php
}
else{
                  ...
                  <div class="panel-body">
                   ...
                   <div id="dvPassport">  
                    <div class="form-group">
                        <label class="col-sm-2 control-label">Select DRONER CLUB/Gallery</label>
                        <div class="col-sm-7 controls">
                         
                          <select name="type1" required>
                           	<option  >Select</option>
                          	<option value="droner">DRONER CLUB</option>
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label">Select pdf of image content</label>
                        <div class="col-sm-7 controls">
