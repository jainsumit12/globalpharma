                    ...
                    <div class="vd_content clearfix">
                        <div class="vd_title-section clearfix">
                            <div class="vd_panel-header">
                                <h1>User Panel</h1>
                                <small class="subtitle">List of Testimonail</small> </div>
                        </div>
...
?>
  ...
  <td class="center"><a href="editnews.php?edit=<?php echo $id; ?> "class=" btn btn-success btn-rounded">Edit</a></td>
  <td class="center"><a href="delnews.php?del=<?php echo $id; ?> "class=" btn btn-danger btn-rounded">Delete</a></td>
