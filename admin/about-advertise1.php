...
<div class="form-group">
                  ...
                  <div class="col-sm-8">
                    ...
                    <input  value="<?php echo $dataval['link1']; ?>" type="text"   name="link1" >
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    ...
                    <input  value="<?php echo $dataval['link2']; ?>" type="text"   name="link2" >
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    ...
                    <input  value="<?php echo $dataval['link4']; ?>" type="text"   name="link4" >
                  </div>
                </div>
            
 
                <div class="form-group">
                  <label class="col-sm-2 control-label">About Data  :</label>
                  <div class="col-sm-8">
                  
                    <textarea  class="ckeditor"   name="content2" ><?php echo $dataval['content2']; ?></textarea>
                  </div>
                </div>	 
                                      ...
                                      <?php  if(isset($_POST['update']))
{
 	...
 	$query1 = "UPDATE extra_content SET    link1='".$_POST['link1']."'  ,link2='".$_POST['link2']."' , link4='".$_POST['link4']."'  ,content2='".$_POST['content2']."'     where id='1'";
