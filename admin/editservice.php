...
<div class="vd_body">
	...
	$query = "SELECT * from services where id='".@$_GET['catid']."'";
	...
	$run = mysqli_query($conn, $query);
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                          ...
                          <input class="width-70" type="text" placeholder="Input" value="<?php echo $dataval['service'];  ?>" data-toggle="tooltip" data-placement="top" name="title" >
                        </div>
                      </div>
                 ...
                 <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                          ...
                          <input class="width-70" type="text" placeholder="Input" value="<?php echo $dataval['content'];  ?>" data-toggle="tooltip" data-placement="top" name="content" >
                        </div>
                      </div>
                        ...
                        <div class="col-sm-7 controls">
                          ...
                          <input class="width-70" type="text" placeholder="Input" value="<?php echo $dataval['image'];  ?>" data-toggle="tooltip" data-placement="top" name="icon" >
                        </div>
                      </div>
...
$image = $_POST['image'];
	...
	$query1 = "UPDATE services SET service='$title', content='$content', image='$image' where id='".$_POST['edit_id']."'";
