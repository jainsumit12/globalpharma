 ...
 $category_name = $_POST['content'];
  ...
  $image_name5 = $_FILES['image5']['name'];
	 ...
	 $image_tmp5 = $_FILES['image5']['tmp_name'];    
	   ...
	   $query1 = "UPDATE extra_content SET image='$imagename5'   where id='1'";
       $me=mysqli_query($conn,$query1);
	 
	 
$field_value=array($design,$category_name,$imagename5);
$field=array('name','content' ,'image');
                  ...
                  <div class="panel-body">
                   <form class="form-horizontal" action="#" method="post" name="form" role="form" enctype="multipart/form-data">
					...
					<div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                          <input class="width-70" type="file" placeholder="Input" data-toggle="tooltip" data-placement="top" name="image5" >
                        </div>
                      </div>  
                      <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
  						 ...
  						 <input class="width-70" type="text" value="" data-toggle="tooltip" data-placement="top" name="content" >
