...
$field_value=array($category_name1,$subcategory_name,$product_name,$product_des,$short_description,$product_sku,$status,$category_name,$sub_name,$hyphenTag1);
$field =array('product_category','product_subcategory','product_name','description','short_description','sku','status','category','subcategory','url');
