                  ...
                  <div class="panel-body table-responsive">
                    <table class="table table-striped" id="data-tables">
                      ...
                      <tbody>
                        <?php
                           $i=1;
 $query="SELECT * from blog where type='download' order by id DESC ";
...
?>
                   ...
                   <td>  
                    ...
                    <a href="view_download.php?delid=<?php echo $row['id']; ?>" data-original-title="delete" data-toggle="tooltip" data-placement="top" class="btn menu-icon vd_bg-grey"> <i class="fa fa-times"></i> </a>
                   </td>
                        </tr>
                       <?php } ?>
                       <?php
                       if(isset($_GET['delid'])){
					   	...
					   	echo'<script>location.assign("view_download.php")</script>';
