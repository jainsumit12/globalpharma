...
$table = "subcategory";
    ...
    $field=array('subcategory_id','subcategory_name');
...
if(isset($_POST['btn-save']))
{
    ...
    $seotopic = strip_tags($catname);
		 ...
		 $field_value=array($catid,$catname,$hyphenTag1);
        $field =array('subcategory_id','subcategory_name','url');
