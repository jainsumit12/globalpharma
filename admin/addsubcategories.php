...
//	  move_uploaded_file($image_tmp,"../images/subcategory/$imagename");
	 // move_uploaded_file($image_tmp,"../images/subcategory/$image_name");
...
$stat='1';
$field_value=array($subcategory_name,$category_name,$hyphenTag1,$stat);
 $field =array('subcategory_name','category_id','url','status');
    ...
    <div data-action="remove-navbar" data-original-title="Remove Navigation Bar Toggle" data-toggle="tooltip" data-placement="bottom" class="remove-navbar-button menu"> <i class="fa fa-arrows-h"></i> </div>
      ...
      <div data-action="fullscreen" data-original-title="Remove Navigation Bar and Top Menu Toggle" data-toggle="tooltip" data-placement="bottom" class="fullscreen-button menu"> <i class="glyphicon glyphicon-fullscreen"></i> </div>
          ...
          <div class="vd_title-section clearfix">
            <div class="vd_panel-header">
              <h1>Add Sub Category Panel</h1>
              <small class="subtitle">Tea Trading Dashboard</small>
...
<!-- vd_panel-menu --> 
          ...
          <div class="row" id="advanced-input">
			...
			<!--	 <div class="form-group">
                        <label class="col-sm-2 control-label">Add Sub Categories Images</label>
                        <div class="col-sm-7 controls">
                  ...
                  <!--       <div class="form-group">
                        <label class="col-sm-2 control-label">Add Categories Content</label>
                        <div class="col-sm-7 controls">
                          
                          <textarea   id="" cols="70" name="content"  required rows="5">
